...
- Build order lives in `architecture.md`; done: **1 DB foundations**, **2 auth**, **3 billing**, **4 contracts**. Pending: 5 email + cron, 6 KV status control, 7 config push (blocked on draft-vs-live).
